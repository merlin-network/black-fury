...
import (
	...
	_ "github.com/merlin-network/black/v6/client/docs/statik"

	"github.com/merlin-network/black/v6/app/ante"
	"github.com/merlin-network/black/v6/x/epochs"
	epochskeeper "github.com/merlin-network/black/v6/x/epochs/keeper"
	epochstypes "github.com/merlin-network/black/v6/x/epochs/types"
	"github.com/merlin-network/black/v6/x/erc20"
	erc20client "github.com/merlin-network/black/v6/x/erc20/client"
	erc20keeper "github.com/merlin-network/black/v6/x/erc20/keeper"
	erc20types "github.com/merlin-network/black/v6/x/erc20/types"
	"github.com/merlin-network/black/v6/x/fees"
	feeskeeper "github.com/merlin-network/black/v6/x/fees/keeper"
	feestypes "github.com/merlin-network/black/v6/x/fees/types"

	"github.com/merlin-network/black/v6/x/inflation"
	inflationkeeper "github.com/merlin-network/black/v6/x/inflation/keeper"
	inflationtypes "github.com/merlin-network/black/v6/x/inflation/types"
	"github.com/merlin-network/black/v6/x/recovery"
	recoverykeeper "github.com/merlin-network/black/v6/x/recovery/keeper"
	recoverytypes "github.com/merlin-network/black/v6/x/recovery/types"
	"github.com/merlin-network/black/v6/x/vesting"
	vestingkeeper "github.com/merlin-network/black/v6/x/vesting/keeper"
	vestingtypes "github.com/merlin-network/black/v6/x/vesting/types"

	//govshuttle imports
	"github.com/merlin-network/black/v6/x/govshuttle"
	govshuttleclient "github.com/merlin-network/black/v6/x/govshuttle/client"
	govshuttlekeeper "github.com/merlin-network/black/v6/x/govshuttle/keeper"
	govshuttletypes "github.com/merlin-network/black/v6/x/govshuttle/types"

	"github.com/merlin-network/black/v6/x/csr"
	csrkeeper "github.com/merlin-network/black/v6/x/csr/keeper"
	csrtypes "github.com/merlin-network/black/v6/x/csr/types"

	v2 "github.com/merlin-network/black/v6/app/upgrades/v2"
	v3 "github.com/merlin-network/black/v6/app/upgrades/v3"
	v4 "github.com/merlin-network/black/v6/app/upgrades/v4"
	v5 "github.com/merlin-network/black/v6/app/upgrades/v5"
)
...
func (app *Black) GetKey(storeKey string) *sdk.KVStoreKey {
...
//
// NOTE: This is solely to be used for testing purposes.
func (app *Black) GetTKey(storeKey string) *sdk.TransientStoreKey {
...
func (app *Black) GetMemKey(storeKey string) *sdk.MemoryStoreKey {
...
func (app *Black) SimulationManager() *module.SimulationManager {
	return app.sm
}
...
func (app *Black) GetStakingKeeper() stakingkeeper.Keeper {
