...
black gentx $KEY 100000000000000000000000ablack --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.165.151.138
...
mv $HOME/.black/config/gentx $HOME/black-fury/Mainnet/gentx-cronos
mv $HOME/.black/config/genesis.json $HOME/black-fury/Mainnet/genesis-cronos.json
