...
type IBCTestingSuite struct {
	...
	pathOsmosisblack  *ibcgotesting.Path
	pathCosmosblack   *ibcgotesting.Path
...
func (suite *IBCTestingSuite) SetupTest() {
	...
	suite.blackChain.App.(*app.Black).RecoveryKeeper.SetParams(suite.blackChain.GetContext(), params)
	...
	suite.coordinator.Setup(suite.pathOsmosisblack) // clientID, connectionID, channelID filled
	suite.coordinator.Setup(suite.pathCosmosblack)
