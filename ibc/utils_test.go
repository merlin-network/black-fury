...
import (
	...
	// "github.com/merlin-network/black/v2/x/claims/types"
...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1",
						Receiver: "black1x2w87cvt5mqjncav4lxy8yfreynn273xrrp06v",
						Amount:   "123456",
					},
				),
			},
		...
		},
		{
			...
			"black1x2w87cvt5mqjncav4lxy8yfreynn273xrrp06v",
			false,
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "black1x2w87cvt5mqjncav4lxy8yfreynn273xrrp06v",
