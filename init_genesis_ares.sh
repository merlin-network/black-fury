...
black gentx $KEY 100000000000000000000000ablack --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.90.61.99
...
mv $HOME/.black/config/gentx $HOME/black-fury/Mainnet/gentx-ares
mv $HOME/.black/config/genesis.json $HOME/black-fury/Mainnet/genesis-ares.json
