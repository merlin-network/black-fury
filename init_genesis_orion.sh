...
black gentx $KEY 100000000000000000000000ablack --keyring-backend $KEYRING --chain-id $CHAINID --ip 34.75.78.143
...
mv $HOME/.black/config/gentx $HOME/black-fury/Mainnet/gentx-orion
mv $HOME/.black/config/genesis.json $HOME/black-fury/Mainnet/genesis-orion.json
